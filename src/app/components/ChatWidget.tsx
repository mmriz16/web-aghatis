        ...
        <div className="fixed bottom-4 right-4 z-[60]">
            ...
            {!isOpen && (
                <button
                    ...
                    className="bg-[#16A34A] text-white rounded-full w-14 h-14 shadow-lg flex items-center justify-center text-2xl hover:bg-[#16A34A]/90 transition-colors"
            ...
            >
                ...
                <div className="h-full w-full p-4 flex flex-col justify-between">
                    ...
                    {/* Messages */}
                    <div ref={listRef} className="flex flex-col gap-2 mt-6 h-[calc(100%-160px)] mb-4 overflow-y-auto no-scrollbar">
                        {messages.map((m, idx) => (
                            <div
                                key={idx}
                                className={[
                                    ...
                                    m.role === 'assistant'
                                        ? 'bg-white rounded-tl-none text-gray-900 border border-black/10 self-start'
                                        : 'bg-white rounded-tr-none text-gray-900 border border-black/10 self-end',
                                ].join(' ')}
                            >
                                {m.role === 'assistant' ? (
                                    <>
